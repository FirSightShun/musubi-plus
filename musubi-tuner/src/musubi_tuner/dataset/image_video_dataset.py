...
class ItemInfo:
    def __init__(
        ...
        # Sample weight for weighted loss training
...
class BucketBatchManager:
    ...
    def __getitem__(self, idx):
        ...
        # inject sample weights for weighted loss
        sample_weights = [getattr(item_info, "sample_weight", 1.0) for item_info in bucket[start:end]]
...
class ImageDataset(BaseDataset):
    ...
    def prepare_for_training(self, num_timestep_buckets: Optional[int] = None):
        ...
        # load sample weights if specified
        sample_weights = {}
